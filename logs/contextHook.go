...
func findCaller(skip int) string {
    ...
    for i := 0; i < 12; i++ {
        ...
        //if strings.HasPrefix(file, "ginutils/logger.go") {
        //    for j:=0;j<20;j++{
        //        _, file1, line1, ok1 := runtime.Caller(j)
        //        if !ok1 {
        //            j=20
        //        }
        //        fmt.Printf("%s:%d\r\n",file1,line1)
        ...
        //
        //}
        if !(strings.HasPrefix(file, "logrus") || strings.HasPrefix(file, "ginutils/logger.go") ){
